...
function limitSetter(betbutton){
    ...
    if (isNaN(bet) || bet <= 0) {
        ...
        document.getElementById("unsufficiantFund").textContent = "Nicht Ausreichendes Guthaben!"
        return;
    }
    ...
    if (Guthaben >= bet) {
        ...
        let zufall4 = Math.random();
        let zufall5 = Math.random();
        let gewichtet = zufall1 * zufall2 * zufall3 * zufall4 * zufall5;    
